...
echo "[EXEC] ${_CWD}/scripts/download.sh ${TERRAHUB_BUILD_LAMBDA_FILE} s3://${TERRAHUB_BUILD_S3_DEPLOY}/${TERRAHUB_BUILD_S3_PATH}/${TERRAHUB_BUILD_LAMBDA_FILE}"
${_CWD}/scripts/download.sh ${TERRAHUB_BUILD_LAMBDA_FILE} s3://${TERRAHUB_BUILD_S3_DEPLOY}/${TERRAHUB_BUILD_S3_PATH}/${TERRAHUB_BUILD_LAMBDA_FILE}
echo "[EXEC] ${_CWD}/scripts/download.sh ${TERRAHUB_BUILD_INDEX_FILE} s3://${TERRAHUB_BUILD_S3_DEPLOY}/${TERRAHUB_BUILD_S3_PATH}/${TERRAHUB_BUILD_INDEX_FILE}"
${_CWD}/scripts/download.sh ${TERRAHUB_BUILD_INDEX_FILE} s3://${TERRAHUB_BUILD_S3_DEPLOY}/${TERRAHUB_BUILD_S3_PATH}/${TERRAHUB_BUILD_INDEX_FILE}

# Compare index file with source path
echo "[EXEC] ${_CWD}/scripts/compare.sh ${_CWD}/${TERRAHUB_BUILD_INDEX_FILE} ${TERRAHUB_BUILD_LOCAL_PATH}"
${_CWD}/scripts/compare.sh ${_CWD}/${TERRAHUB_BUILD_INDEX_FILE} ${TERRAHUB_BUILD_LOCAL_PATH}
...
# Archive folder
echo "[EXEC] ${_CWD}/scripts/zip.sh -r ${TERRAHUB_BUILD_LAMBDA_FILE} ${TERRAHUB_BUILD_SOURCE_PATH}/ ${TERRAHUB_BUILD_LOCAL_PATH}/"
${_CWD}/scripts/zip.sh -r ${TERRAHUB_BUILD_LAMBDA_FILE} ${TERRAHUB_BUILD_SOURCE_PATH}/ ${TERRAHUB_BUILD_LOCAL_PATH}/
...
echo "[EXEC] ${_CWD}/scripts/upload.sh ${TERRAHUB_BUILD_LAMBDA_FILE} s3://${TERRAHUB_BUILD_S3_DEPLOY}/${TERRAHUB_BUILD_S3_PATH}/${TERRAHUB_BUILD_LAMBDA_FILE}"
${_CWD}/scripts/upload.sh ${TERRAHUB_BUILD_LAMBDA_FILE} s3://${TERRAHUB_BUILD_S3_DEPLOY}/${TERRAHUB_BUILD_S3_PATH}/${TERRAHUB_BUILD_LAMBDA_FILE}

# Upload local build to S3 runtime
echo "[EXEC] ${_CWD}/scripts/upload.sh ${TERRAHUB_BUILD_INDEX_FILE} s3://${TERRAHUB_BUILD_S3_DEPLOY}/${TERRAHUB_BUILD_S3_PATH}/${TERRAHUB_BUILD_INDEX_FILE}"
${_CWD}/scripts/upload.sh ${TERRAHUB_BUILD_INDEX_FILE} s3://${TERRAHUB_BUILD_S3_DEPLOY}/${TERRAHUB_BUILD_S3_PATH}/${TERRAHUB_BUILD_INDEX_FILE}

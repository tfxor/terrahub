...
$ terrahub plan
💡 [s3-bucket] terraform plan -no-color -var-file=s3-bucket/default.tfvars -out=s3-bucket/.resource/terraform.tfplan
...
💡 [s3-bucket] terraform apply -no-color -var-file=s3-bucket/default.tfvars -auto-approve=true -state-out=s3-bucket/.resource/terraform.tfstate
